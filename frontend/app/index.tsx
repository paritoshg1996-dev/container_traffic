...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: 14, padding: 14, fontSize: 16, color: COLORS.text, minHeight: 56, paddingVertical: 16, fontFamily: "Inter_400Regular", lineHeight: 22 },
